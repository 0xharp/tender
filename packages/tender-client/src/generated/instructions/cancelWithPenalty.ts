...
export const CANCEL_WITH_PENALTY_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([196, 207, 149, 106, 64, 14, 217, 179]);

export function getCancelWithPenaltyDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    CANCEL_WITH_PENALTY_DISCRIMINATOR,
  );
}

export type CancelWithPenaltyInstruction<
...
export type CancelWithPenaltyInstructionData = {
  discriminator: ReadonlyUint8Array;
  milestoneIndex: number;
};

export type CancelWithPenaltyInstructionDataArgs = { milestoneIndex: number };

export function getCancelWithPenaltyInstructionDataEncoder(): FixedSizeEncoder<CancelWithPenaltyInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ["discriminator", fixEncoderSize(getBytesEncoder(), 8)],
      ["milestoneIndex", getU8Encoder()],
    ]),
    (value) => ({ ...value, discriminator: CANCEL_WITH_PENALTY_DISCRIMINATOR }),
  );
}

export function getCancelWithPenaltyInstructionDataDecoder(): FixedSizeDecoder<CancelWithPenaltyInstructionData> {
...
export function getCancelWithPenaltyInstructionDataCodec(): FixedSizeCodec<
  CancelWithPenaltyInstructionDataArgs,
  CancelWithPenaltyInstructionData
> {
  return combineCodec(
    getCancelWithPenaltyInstructionDataEncoder(),
    getCancelWithPenaltyInstructionDataDecoder(),
  );
}

export type CancelWithPenaltyAsyncInput<
...
> = {
  ...
  milestoneIndex: CancelWithPenaltyInstructionDataArgs["milestoneIndex"];
};

export async function getCancelWithPenaltyInstructionAsync<
  TAccountBuyer extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getCancelWithPenaltyInstructionDataEncoder().encode(
      args as CancelWithPenaltyInstructionDataArgs,
    ),
    programAddress,
  } as CancelWithPenaltyInstruction<
    TProgramAddress,
    TAccountBuyer,
    TAccountRfp,
    TAccountMilestone,
...
export type CancelWithPenaltyInput<
  TAccountBuyer extends string = string,
  TAccountRfp extends string = string,
  TAccountMilestone extends string = string,
  TAccountEscrow extends string = string,
...
export function getCancelWithPenaltyInstruction<
  TAccountBuyer extends string,
  TAccountRfp extends string,
  TAccountMilestone extends string,
  TAccountEscrow extends string,
...
export type ParsedCancelWithPenaltyInstruction<
  TProgram extends string = typeof TENDER_PROGRAM_ADDRESS,
...
> = {
  ...
  data: CancelWithPenaltyInstructionData;
};

export function parseCancelWithPenaltyInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedCancelWithPenaltyInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getCancelWithPenaltyInstructionDataDecoder().decode(instruction.data),
  };
}
