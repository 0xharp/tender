...
export const ACCEPT_MILESTONE_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([67, 203, 235, 220, 254, 79, 251, 205]);

export function getAcceptMilestoneDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    ACCEPT_MILESTONE_DISCRIMINATOR,
  );
}

export type AcceptMilestoneInstruction<
...
export type AcceptMilestoneInstructionData = {
  discriminator: ReadonlyUint8Array;
  milestoneIndex: number;
};

export type AcceptMilestoneInstructionDataArgs = { milestoneIndex: number };

export function getAcceptMilestoneInstructionDataEncoder(): FixedSizeEncoder<AcceptMilestoneInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ["discriminator", fixEncoderSize(getBytesEncoder(), 8)],
      ["milestoneIndex", getU8Encoder()],
    ]),
    (value) => ({ ...value, discriminator: ACCEPT_MILESTONE_DISCRIMINATOR }),
  );
}

export function getAcceptMilestoneInstructionDataDecoder(): FixedSizeDecoder<AcceptMilestoneInstructionData> {
...
export function getAcceptMilestoneInstructionDataCodec(): FixedSizeCodec<
  AcceptMilestoneInstructionDataArgs,
  AcceptMilestoneInstructionData
> {
  return combineCodec(
    getAcceptMilestoneInstructionDataEncoder(),
    getAcceptMilestoneInstructionDataDecoder(),
  );
}

export type AcceptMilestoneAsyncInput<
...
> = {
  ...
  milestoneIndex: AcceptMilestoneInstructionDataArgs["milestoneIndex"];
};

export async function getAcceptMilestoneInstructionAsync<
  TAccountBuyer extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getAcceptMilestoneInstructionDataEncoder().encode(
      args as AcceptMilestoneInstructionDataArgs,
    ),
    programAddress,
  } as AcceptMilestoneInstruction<
    TProgramAddress,
    TAccountBuyer,
    TAccountRfp,
    TAccountMilestone,
...
export function getAcceptMilestoneInstruction<
  TAccountBuyer extends string,
  TAccountRfp extends string,
  TAccountMilestone extends string,
  TAccountEscrow extends string,
...
export type ParsedAcceptMilestoneInstruction<
  TProgram extends string = typeof TENDER_PROGRAM_ADDRESS,
...
> = {
  ...
  data: AcceptMilestoneInstructionData;
};

export function parseAcceptMilestoneInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedAcceptMilestoneInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getAcceptMilestoneInstructionDataDecoder().decode(instruction.data),
  };
}
