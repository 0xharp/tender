...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "rfp_close_bidding", hash = "c8270ba244935132", spec_hash = "58c2cf2fc862df1f", accounts = "RfpCloseBidding", accounts_file = "src/instructions/rfp_close_bidding.rs", accounts_hash = "eb56438cc871d736")]
