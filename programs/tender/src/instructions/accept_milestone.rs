...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "accept_milestone", hash = "085bfc5dce534eaa", spec_hash = "8d9e7d6dc683a0cc", accounts = "AcceptMilestone", accounts_file = "src/instructions/accept_milestone.rs", accounts_hash = "18dd92c1949c64f2")]
