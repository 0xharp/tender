...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "expire_rfp", hash = "ae061276835fdec0", spec_hash = "f391a345576fc459", accounts = "ExpireRfp", accounts_file = "src/instructions/expire_rfp.rs", accounts_hash = "a349a36258a5dbfc")]
