...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "fund_project", hash = "fbd42046e30dd884", spec_hash = "eb13cdc0708386f6", accounts = "FundProject", accounts_file = "src/instructions/fund_project.rs", accounts_hash = "None")]
