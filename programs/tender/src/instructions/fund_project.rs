...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "fund_project", hash = "fbd42046e30dd884", spec_hash = "095a501c5efcb97b", accounts = "FundProject", accounts_file = "src/instructions/fund_project.rs", accounts_hash = "b36b8ff2e7770e5e")]
