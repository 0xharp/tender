...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "close_withdrawn_bid", hash = "04548e2838819f8a", spec_hash = "629a207c9f06acde", accounts = "CloseWithdrawnBid", accounts_file = "src/instructions/close_withdrawn_bid.rs", accounts_hash = "a8c597541dc8e407")]
