...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "rfp_create", hash = "a3023401f49652f4", spec_hash = "72add47e32a3a3d0", accounts = "RfpCreate", accounts_file = "src/instructions/rfp_create.rs", accounts_hash = "13b7ae01e9a861f3")]
