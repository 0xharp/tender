...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "cancel_with_notice", hash = "f48d73ef52c47ffa", spec_hash = "a603a2b30c78ecdc", accounts = "CancelWithNotice", accounts_file = "src/instructions/cancel_with_notice.rs", accounts_hash = "eb1dc94486e12def")]
