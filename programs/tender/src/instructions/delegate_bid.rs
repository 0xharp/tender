...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "delegate_bid", hash = "be9438b29ed6facb", spec_hash = "31e4debf55bda6cc", accounts = "DelegateBid", accounts_file = "src/instructions/delegate_bid.rs", accounts_hash = "43a8b5ecf02b460a")]
