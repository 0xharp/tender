...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "delegate_bid", hash = "be9438b29ed6facb", spec_hash = "6048cde83d9ebb13", accounts = "DelegateBid", accounts_file = "src/instructions/delegate_bid.rs", accounts_hash = "43a8b5ecf02b460a")]
