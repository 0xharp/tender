...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "resolve_dispute", hash = "4546c1f59c828b3a", spec_hash = "469b44fbb0ba5228", accounts = "ResolveDispute", accounts_file = "src/instructions/resolve_dispute.rs", accounts_hash = "bae7a320a7d79324")]
pub fn handler(
