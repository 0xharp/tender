...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "resolve_dispute", hash = "c2acbe367a31bbde", spec_hash = "469b44fbb0ba5228", accounts = "ResolveDispute", accounts_file = "src/instructions/resolve_dispute.rs", accounts_hash = "bae7a320a7d79324")]
pub fn handler(
