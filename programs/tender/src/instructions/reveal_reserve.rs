...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "reveal_reserve", hash = "a3bea4bbaa9e5acf", spec_hash = "f2e704fbd647b51c", accounts = "RevealReserve", accounts_file = "src/instructions/reveal_reserve.rs", accounts_hash = "5d6630bf5f10eddd")]
