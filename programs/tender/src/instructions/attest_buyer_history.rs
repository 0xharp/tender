...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "attest_buyer_history", hash = "07849d091d8fb78a", spec_hash = "505c45be6d999c4a", accounts = "AttestBuyerHistory", accounts_file = "src/instructions/attest_buyer_history.rs", accounts_hash = "fa386906e274fd33")]
