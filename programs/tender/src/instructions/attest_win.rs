...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "attest_win", hash = "ba32e7fd4c3c7cd6", spec_hash = "038b67880cdf3da8", accounts = "AttestWin", accounts_file = "src/instructions/attest_win.rs", accounts_hash = "45385970ba6ca7d0")]
