...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "attest_win", hash = "ae7b3a8a13a55713", spec_hash = "05ef4e651569f3c8", accounts = "AttestWin", accounts_file = "src/instructions/attest_win.rs", accounts_hash = "None")]
