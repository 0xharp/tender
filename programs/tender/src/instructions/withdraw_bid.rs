...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "withdraw_bid", hash = "1080b3e96579f21d", spec_hash = "137e93ebaff1c3e0", accounts = "WithdrawBid", accounts_file = "src/instructions/withdraw_bid.rs", accounts_hash = "842a1976764d8858")]
