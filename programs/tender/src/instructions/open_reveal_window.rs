...
#[qedgen_macros::qed(verified, spec = "../../tender.qedspec", handler = "open_reveal_window", hash = "6ad232e1591c64b5", spec_hash = "bd7eebbebf4d9308", accounts = "OpenRevealWindow", accounts_file = "src/instructions/open_reveal_window.rs", accounts_hash = "f7237821173bd7f1")]
